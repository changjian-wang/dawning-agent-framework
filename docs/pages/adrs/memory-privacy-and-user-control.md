...
archived_reason: ""
supersedes: []
related: [pages/adrs/important-action-levels-and-confirmation.md, pages/adrs/mvp-main-scenario-information-curation.md, pages/adrs/mvp-input-boundary-no-default-folder-reading.md]
...
- [ADR-012 MVP 输入边界：不默认读取用户文件夹](mvp-input-boundary-no-default-folder-reading.md)：定义第一版信息整理不默认读取用户文件夹。
