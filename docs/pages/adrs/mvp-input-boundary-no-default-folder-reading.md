...
archived_reason: ""
supersedes: []
related: [pages/adrs/mvp-main-scenario-information-curation.md, pages/adrs/memory-privacy-and-user-control.md, pages/adrs/interest-profile-weighting-and-decay.md, pages/adrs/mvp-first-slice-chat-inbox-read-side.md]
...
- [ADR-014 MVP 第一版切片：聊天 + inbox + 读侧整理](mvp-first-slice-chat-inbox-read-side.md)：定义第一版输入和动作范围。
