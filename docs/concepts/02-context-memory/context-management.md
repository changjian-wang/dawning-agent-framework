...
> LLM 基础概念见 [LLM 技术原理](../00-foundations/llm-fundamentals.md)。
>
...
- [LLM 技术原理](../00-foundations/llm-fundamentals.md) — Token、API、采样等基础概念
- [Agent Loop](../01-agent-core/agent-loop.md) — ReAct / Plan-and-Execute / Reflexion 执行模式
- [LLM Wiki 模式](../00-foundations/llm-wiki-pattern.zh-CN.md) — 编译式知识管理与记忆面设计
