...
sources: [concepts/01-agent-core/agent-loop.md, concepts/04-prompt-eval/prompt-engineering-dspy.zh-CN.md]
created: 2026-04-17
updated: 2026-04-17
status: active
---
...
- [[concepts/01-agent-core/agent-loop.md]] — 最基础的 Loop 结构
