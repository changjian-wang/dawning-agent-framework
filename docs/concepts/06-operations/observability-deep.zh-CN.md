...
sources: [concepts/01-agent-core/agent-loop.md, concepts/04-prompt-eval/agent-evaluation.zh-CN.md]
created: 2026-04-17
updated: 2026-04-17
status: active
---
...
- [1. Agent 可观测性的独特挑战](#1-agent-可观测性的独特挑战)
- [2. 三个标准](#2-三个标准)
- [3. Trace 结构设计](#3-trace-结构设计)
- [4. 与 Metrics / Logs 的联动](#4-与-metrics--logs-的联动)
- [5. 可视化工具对比](#5-可视化工具对比)
- [6. Dawning 的可观测性设计](#6-dawning-的可观测性设计)
- [7. 数据量与采样](#7-数据量与采样)
- [8. 隐私与合规](#8-隐私与合规)
- [9. Dawning 与主流工具对接](#9-dawning-与主流工具对接)
- [10. 与 Eval 的联动](#10-与-eval-的联动)
- [11. 调试实战](#11-调试实战)
- [12. 小结](#12-小结)
- [13. 延伸阅读](#13-延伸阅读)
<!-- /TOC-AUTOGEN -->
