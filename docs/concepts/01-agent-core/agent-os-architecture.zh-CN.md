...
sources: [decisions/roadmap.zh-CN.md, concepts/00-foundations/llm-wiki-pattern.zh-CN.md, comparisons/agent-framework-landscape.zh-CN.md]
created: 2026-04-17
updated: 2026-04-17
status: active
---
...
- [concepts/00-foundations/llm-wiki-pattern.zh-CN.md](../00-foundations/llm-wiki-pattern.zh-CN.md) — 编译式知识管理
