...
Read PURPOSE and SCHEMA before any write operation under `docs/`. For application code outside `docs/`, read PURPOSE and relevant ADRs first, and follow the plan-first rule.
